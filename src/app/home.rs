...
use cosmic::iced::{Center, Length, Pixels};
                                ...
                                cosmic::widget::flex_row(vec![
                                    ...
                                    cosmic::widget::container(cosmic::widget::Column::with_children(vec![
                                        cosmic::widget::icon::from_name("applications-audio-symbolic")
                                            .size(192)
                                            .into(),
                                        cosmic::widget::icon::from_name("default-media-symbolic").into(),
                                    ]))
                                        .into(),
                                ])
                                ...
                                cosmic::widget::container(
                                    cosmic::widget::flex_row(vec![
                                        ...
                                        cosmic::widget::row::with_children(vec![
                                            cosmic::widget::text::heading("00:00")
                                                .into(),
                            ...
                            cosmic::widget::container(cosmic::widget::column::with_children(vec![
                                cosmic::widget::flex_row(vec![
                                    ...
                                    cosmic::widget::container(cosmic::widget::Column::with_children(vec![
                                        match val.get(0) {
                                            ...
                                            Some(track) => {
                                                cosmic::widget::image(track.clone().cover_art.unwrap()).height(192.0).width(192.0)
                                ...
                                cosmic::widget::container(
                                    cosmic::widget::flex_row(vec![
                                        // Media Progress
                                        cosmic::widget::row::with_children(vec![
                                            cosmic::widget::text::heading("0:26")
                                                .into(),
